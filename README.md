...
*Note:*  to be used for RNBO you need to flash the bootloader to your Daisy device first, the easiest way would be using the [Daisy Web Programmer](https://electro-smith.github.io/Programmer/)
